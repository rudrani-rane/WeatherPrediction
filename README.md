...
It is a comparative research study analyzing limitations in existing weather forecasting models, specifically
targeting challenges in localized prediction for micro-climate zones (coastal regions).
Authored a comprehensive research paper detailing the methodology, results, and architectural choices for the
model, slated for academic submission.
